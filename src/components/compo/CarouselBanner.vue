...
export default {
      ...
      banners: [
        {
          ...
          imageMobile: require("@/assets/images/banners/banner1-mobile.jpg"),
        ...
        },
        {
          ...
          imageMobile: require("@/assets/images/banners/banner2-mobile.jpg"),
        ...
        },
        {
          ...
          imageMobile: require("@/assets/images/banners/banner3-mobile.jpg"),
          title: "Sản phẩm mới",
  ...
  mounted() {
    ...
    const carouselElement = this.$refs.carouselBanner;
  ...
  beforeUnmount() {
    ...
    // Loại bỏ sự kiện hover
    const carouselElement = this.$refs.carouselBanner;
    carouselElement.removeEventListener("mouseenter", this.stopAutoplay);
    carouselElement.removeEventListener("mouseleave", this.startAutoplay);
